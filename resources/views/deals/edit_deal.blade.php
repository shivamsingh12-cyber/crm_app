          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="fName" class="form-control" name="amount" value="{{ $deal_detail->amount }}"/>
                @error('amount')
              ...
              <div class="form-group">
                ...
                <input type="text" id="lName" class="form-control" name="deal_name" value="{{ $deal_detail->deal_name }}">
                @error('deal_name')
                  <small class="text-danger">{{$message}}</small>
                @enderror
              </div>
              <div class="form-group">
                ...
                <input type="date" id="title" class="form-control" name="closing_date" value="{{ $deal_detail->closing_date }}">
                @error('closing_date')
                  <small class="text-danger">{{$message}}</small>
                @enderror
              </div>    
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" class="form-control custom-select" name="deal_stage">
                  ...
                  @if ($single == $deal_detail->deal_stage)
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" class="form-control custom-select" name="account_id">
                  ...
                  @if ($single->id==$deal_detail->account_id)
              ...
              <div class="form-group">
                ...
                <select id="inputStatus" class="form-control custom-select" name="contact_id">
                  ...
                  @if ($single->id==$deal_detail->contact_id)      
                  <option value="{{ $single->id }}" selected>{{ $single->contact_name }}</option>
                  @else
